                  ...
                  <td className="px-4 py-2">
                    <div className="flex items-center gap-2">
                      ...
                      {contarRelaciones(hallazgo.id) > 0 ? (
                        <svg width="12" height="12" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" title={`${contarRelaciones(hallazgo.id)} relaciones`}><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/></svg>
                      ) : (
                        <span style={{ fontSize: 'var(--text-xs)', color: 'var(--text-muted)' }}>—</span>
                      )}
                    </div>
